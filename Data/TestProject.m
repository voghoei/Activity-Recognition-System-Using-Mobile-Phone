...
folderName = strcat('TestProcessedData-nbcol-',num2str(nbcol),'-lev-',num2str(lev),'-bin-',num2str(bin));
mkdir(folderName);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%filename = uigetfile;
filename = dir ('Test(2)\Test3\*.csv');
for i=1:length(filename)
  
D = dlmread(strcat('Test(2)\Test3\',filename(i).name),',',1,0);
...
function classId = classGenerate()
classId = 0;
